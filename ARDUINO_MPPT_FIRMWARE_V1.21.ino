/*  PROJECT FUGU FIRMWARE V1.21  (DIY 1kW Open Source MPPT Solar Charge Controller)
...
int
MpptMode                = 1,           //  USER PARAMETER - 0=PSU, 1=MPPT P&O, 2=MPPT Inc.Cond 
...
float 
voltageBatteryMax       = 12.3000,     //   USER PARAMETER - Maximum Battery Charging Voltage (Output V)
voltageBatteryMin       = 9.4000,     //   USER PARAMETER - Minimum Battery Charging Voltage (Output V)
currentCharging         = 1.0000,     //   USER PARAMETER - Maximum Charging Current (A - Output)
...
void loop() {
  ...
  fanSpeed = fan.Handle(temperature);                 //Fan.h - Handle the fan
